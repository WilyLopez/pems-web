  ...
  if (arqueos.length === 0) {
    return (
      <div className="py-6 text-center space-y-2">
        <ClipboardCheck className="mx-auto h-8 w-8 text-gray-200 dark:text-gray-700" />
  ...
  return (
    <div className="space-y-2">
      {arqueos.map((a) => (
        <div
          key={a.id}
          className="flex items-start justify-between gap-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl px-4 py-3"
        >
