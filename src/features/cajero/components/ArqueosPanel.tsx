        ...
        >
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {a.observaciones && (
                <span className="text-xs text-gray-400 truncate">{a.observaciones}</span>
              )}
            </div>
            <div className="text-sm mt-1 flex items-center gap-3">
              <span className="text-gray-500">
                Esperado: <span className="font-semibold text-gray-800">{formatCurrency(a.saldoEsperado)}</span>
              </span>
              <span className="text-gray-300">|</span>
              <span className="text-gray-500">
                Contado: <span className="font-semibold text-gray-800">{formatCurrency(a.saldoContado)}</span>
              </span>
            </div>
          </div>

          <div className="text-right shrink-0">
            <p className="text-[10px] text-gray-400 uppercase tracking-wide">Diferencia</p>
            <p className={cn(
