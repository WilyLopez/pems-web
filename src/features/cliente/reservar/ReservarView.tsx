...
import { getReservationSchema } from '@/features/public/shared/validations'
...
export function ReservarView() {
  ...
  const { edadMin: minAge, edadMax: maxAge } = useEdadNinos()
  ...
  const cancelar = useMutation({
    mutationFn: (id: number) =>
      reservaService.cancelar(
        id,
        'Cancelado por el usuario desde la pantalla de éxito'
      ),
