...
export function ZonaDeJuegosView() {
  ...
  const horarioFinDeSemana =
    config?.horarioFinDeSemana ?? 'Sáb–Dom: 9:00 am – 9:00 pm'
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-brand-azul/10 via-white to-brand-menta/10">
        ...
        <div className="container max-w-6xl mx-auto px-4 text-center space-y-5">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Atracciones para niños de 1 a 12 años. Diversión garantizada con la
          ...
          <div className="container max-w-6xl mx-auto px-4">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 mt-1">
                Cada zona tiene personal de supervisión y equipamiento
                certificado
              </p>
            </div>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
