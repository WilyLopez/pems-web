              ...
              <Tabs value={tabActivo} onValueChange={setTab}>
                        ...
                        {evento.modalidadPago === 'CUOTAS' && evento.cuotas && evento.cuotas.length > 0 ? (
                          <div className="border-t border-gray-100 pt-4 space-y-3">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-bold text-gray-900">Plan de cuotas</h4>
                              ...
                              {evento.cuotas.map((cuota) => (
                                <div
                                  ...
                                  className={cn(
                                    ...
                                    cuota.estado === 'PAGADO' && 'bg-green-50/50'
                                  )}
                                >
                                  <span
                                    className={cn(
                ...
                <TabsContent value="rentabilidad" className="mt-4">
                  <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-5">
                    <h3 className="text-sm font-bold text-gray-900">Rentabilidad del evento</h3>
                    {resumenFinanciero ? (
                      <>
                        {(() => {
                          ...
                          return (
                            <>
                              <div className="grid grid-cols-2 gap-3">
                                {[
                                  { label: 'Ingreso contrato',     value: resumenFinanciero.ingresoContrato,        color: 'text-gray-900' },
                                  { label: 'Adelanto recibido',    value: resumenFinanciero.montoAdelanto,           color: 'text-blue-700' },
                                  { label: 'Gastos adicionales',   value: resumenFinanciero.totalGastosAdicionales,  color: 'text-orange-600' },
                                  { label: 'Utilidad bruta',       value: resumenFinanciero.utilidadBruta,           color: positivo ? 'text-emerald-700' : 'text-red-600' },
                              ...
                              <div className="space-y-1.5">
                                <div className="flex justify-between text-xs text-gray-500">
                                  ...
                                  <span className={`font-black ${positivo ? 'text-emerald-700' : 'text-red-600'}`}>
                                    {margen.toFixed(1)}%
                                  </span>
                                </div>
                          ...
                          >
                            ...
                            >
                              {item.completada
                                ...
                                : <Circle className="h-5 w-5 text-gray-300 hover:text-brand-azul transition-colors" />}
                            </button>
                            <div className="flex-1 min-w-0">
