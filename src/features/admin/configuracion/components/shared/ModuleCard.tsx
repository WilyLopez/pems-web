  ...
  return (
    <div className="bg-card rounded-2xl border border-border p-5 flex flex-col gap-4">
      ...
      <div className="flex gap-2 mt-auto">
        <Button size="sm" variant="outline" className="flex-1" onClick={() => setActive('view')}>
      ...
      <Dialog open={activeModal === 'view'} onOpenChange={(v) => !v && setActive(null)}>
      ...
      <Dialog open={activeModal === 'edit'} onOpenChange={(v) => !v && setActive(null)}>
