...
export const ReservaStatusBadge = React.memo(
  ({
    estado,
    ingresado,
    esReprogramacion,
    fechaEvento,
  }: ReservaStatusBadgeProps) => {
    ...
    return (
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {esReprogramacion && estado !== 'REPROGRAMADA' && (
          <Badge
            variant="outline"
            className="text-[9px] bg-purple-50 text-purple-600 border-purple-200 uppercase tracking-tighter px-1 h-4"
          >
            Reprog.
          </Badge>
        )}
