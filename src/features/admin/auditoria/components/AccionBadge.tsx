...
const STYLES: Record<string, string> = {
  ...
  LOGIN_FALLIDO: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
  ...
  REPROGRAMAR: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400',
  FIRMAR: 'bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-400',
  ABRIR: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400',
  ...
  ACTIVAR: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  DESACTIVAR: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400',
  RESPONDER: 'bg-sky-100 text-sky-800 dark:bg-sky-900/30 dark:text-sky-400',
  MARCAR_SPAM: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
}
...
export function AccionBadge({ accion }: { accion: string }) {
  return (
    <Badge
      ...
      className={cn(
        'font-medium text-xs',
        STYLES[accion] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400'
      )}
    >
      {accion}
    </Badge>
