...
export const paqueteSchema = z.object({
  ...
  color: z
    .string()
    .regex(/^#[0-9A-Fa-f]{6}$/, 'Formato de color inválido (debe ser #RRGGBB)')
    .optional()
    .or(z.literal('')),
        ...
        <div className="flex flex-col w-full h-full overflow-hidden">
                ...
                <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 mb-4 text-sm text-blue-800 flex items-center justify-between">
                  <div>
                    <p className="font-semibold">
                      Existe un borrador pendiente de este paquete.
                    </p>
                    <p className="text-xs text-blue-600">
                      ¿Deseas restaurar la información o empezar de nuevo?
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    {errors.tipoEventoCodigo && (
                      <p className="text-xs text-destructive">
                        {errors.tipoEventoCodigo.message}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                        ...
                        <div className="flex-1">
                          ...
                          {errors.beneficios?.[i]?.valor && (
                            <p className="text-[10px] text-destructive mt-0.5">
                              {errors.beneficios[i].valor.message}
                            </p>
                          )}
                        </div>
                    ...
                    {errors.beneficios && !Array.isArray(errors.beneficios) && (
                      <p className="text-xs text-destructive">
                        {(errors.beneficios as any).message}
                      </p>
                    )}
                  </div>
          ...
          <div className="border-t px-6 py-4 bg-white shrink-0 flex justify-end gap-2">
            ...
            <Button
              type="submit"
              form="paquete-form"
              disabled={uploading || tiposEvento.length === 0}
