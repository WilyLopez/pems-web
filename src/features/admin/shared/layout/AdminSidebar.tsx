  ...
  items: { label: string; href: string; icon: LucideIcon; exact?: boolean }[]
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Servicios', href: '/admin/comercial/servicios', icon: LayoutGrid },
...
export function AdminSidebar() {
  ...
  if (isDesktop === null) {
    return <div className="w-[240px] shrink-0 border-r border-gray-100 bg-white hidden lg:block h-dvh" />
  }
    ...
    <TooltipProvider delayDuration={100}>
      ...
      {!isDesktop && (
        <aside className={cn(
          ...
          <SidebarContent collapsed={false} isActive={isActive} onItemClick={closeMobile} />
