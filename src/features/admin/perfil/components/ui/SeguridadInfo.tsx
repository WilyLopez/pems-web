...
import { UsuarioAdmin, getEstadoAdmin } from '@/features/admin/usuarios/types'
    ...
    <div className={cn('rounded-2xl border p-4 space-y-3', v.border, v.bg)}>
      <div
        className={cn(
          ...
          v.bg === 'bg-gray-50' ? 'bg-white border border-gray-200' : v.bg
        )}
      >
    ...
    <div className="rounded-2xl border border-gray-100 bg-white p-6">
        ...
        <div className="mt-5 rounded-xl bg-red-50 border border-red-200 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-red-600 mt-1">
              Tu cuenta está bloqueada por exceso de intentos fallidos. Se
              desbloqueará automáticamente el{' '}
              {formatDateTime(admin.bloqueadoHasta!)}. Si necesitas acceso
              urgente contacta al administrador principal.
            </p>
          </div>
        </div>
      )}
        ...
        <div className="mt-5 rounded-xl bg-amber-50 border border-amber-200 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-600 mt-1">
              Por política de seguridad debes actualizar tu contraseña. Ve a la
              pestaña de Contraseña para actualizarla.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="mt-5 pt-4 border-t border-gray-100">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {[
            {
              ok: admin.intentosFallidos === 0,
              msg: 'Sin intentos de acceso sospechosos',
            },
            ...
            <div key={msg} className="flex items-center gap-2">
              ...
              <p
                className={cn('text-xs', ok ? 'text-gray-600' : 'text-red-600')}
              >
                {msg}
              </p>
            </div>
