...
const items = [
  ...
  { color: 'bg-brand-rosa/4 border border-brand-rosa/20', label: 'Evento parcial'   },
  { color: 'bg-brand-rosa/8 border border-brand-rosa/40', label: 'Evento lleno'     },
  { color: 'bg-red-50 border border-red-300',             label: 'Bloqueado'        },
  { color: 'bg-purple-50 border border-purple-200',       label: 'Feriado'          },
  { color: 'bg-brand-azul/5 border border-brand-azul/20', label: 'Programacion activa' },
