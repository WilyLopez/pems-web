...
function InfoBanner({
  ...
  return (
    <div
      className={cn(
        'flex items-start gap-2.5 border rounded-xl px-3.5 py-3',
        cls
      )}
    >
      ...
      return (
        <div className="space-y-2">
          <BannerEvento
            ...
            idEvento={disp?.idEventoT1}
            turno="T1"
          />
          <BannerEvento
            titulo={disp?.tituloEventoT2}
            idEvento={disp?.idEventoT2}
            turno="T2"
          />
        </div>
      )
      ...
      return (
        <div className="space-y-2">
          ...
          {disp?.disponiblePrivado && (
            ...
            >
              <Link
                href={`/admin/eventos/nuevo?fecha=${fecha}&turno=${turnoLibre}`}
              >
                <PartyPopper className="h-3.5 w-3.5" />
          ...
          {aforoCompleto ? (
            <div className="flex items-center justify-between bg-orange-50 border border-orange-200 rounded-xl px-3.5 py-3">
              ...
              <Link
                ...
                className="text-[11px] font-semibold text-brand-azul hover:underline shrink-0"
              >
                Ver lista
              </Link>
            </div>
