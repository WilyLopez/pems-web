...
export const DrawerReservationsList = React.memo(
  ({ reservas, fecha }: DrawerReservationsListProps) => {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {reservas.length > 5 && (
              <Badge
                variant="outline"
                className="text-[10px] font-bold text-brand-azul border-brand-azul/20"
              >
