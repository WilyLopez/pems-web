      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="mt-2">
          ...
          <Row
            ...
            value={usuario.sedeNombre ?? `ID ${usuario.idSede}`}
          />
          <Row
            label={
              <span className="flex items-center gap-1">
            ...
            value={
              usuario.ultimoAcceso ? formatDateTime(usuario.ultimoAcceso) : '—'
            }
          />
          <Row
            label={
            ...
            value={formatDateTime(usuario.fechaCreacion)}
          />
          {usuario.bloqueadoHasta && (
            <Row
              label="Bloqueado hasta"
              value={formatDateTime(usuario.bloqueadoHasta)}
            />
          )}
            ...
            <Row
              ...
              value={
                <span className="flex items-center gap-1 text-amber-600 text-xs">
                  <AlertTriangle className="h-3 w-3" /> Debe cambiar al iniciar
                  sesión
                </span>
              }
            />
