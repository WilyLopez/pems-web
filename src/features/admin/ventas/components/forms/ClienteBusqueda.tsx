...
import { Search, User, UserCheck, Loader2, UserPlus } from 'lucide-react'
      ...
      <>
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <p className="font-semibold text-xs text-gray-800 dark:text-gray-200">
                No tiene cuenta, registrar ahora
              </p>
              <p className="text-[10px] text-gray-500 dark:text-gray-400">
                Crear un cliente nuevo con sus datos
              </p>
            </div>
          </button>
        </div>
        <NuevoClienteModal
          ...
          onCreated={(cliente) => onClienteSelect(cliente)}
