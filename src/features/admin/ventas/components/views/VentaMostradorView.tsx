...
export const VentaMostradorView = ({ onClose }: VentaMostradorViewProps) => {
  ...
  const onSubmit = (formData: VentaMostradorFormValues) => {
    ...
    if (efectivoInsuficiente) {
      toast.error(
        'El efectivo recibido es menor que el monto cobrado en efectivo'
      )
      return
    }
          ...
          <div className="order-last lg:order-first space-y-6">
            <section className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-black text-gray-700 dark:text-gray-300 uppercase">
                  Proceso de venta
                </h2>
              </div>
                      ...
                      {precioDia &&
                        ...
                        !estaBloqueado && (
                          ...
                          >
                            ...
                            <AlertDescription className="text-[10px] leading-tight">
                              No hay tarifa activa para esta fecha. Configura
                              una tarifa antes de registrar la venta.
                            </AlertDescription>
                          </Alert>
                        )}
                    ...
                    >
                      ...
                      {exceedsAforo && (
                        ...
                        >
                          ...
                          <AlertDescription className="text-[10px] leading-tight">
                            Solo hay {plazasDisponibles} lugar
                            {plazasDisponibles !== 1 ? 'es' : ''} disponible
                            {plazasDisponibles !== 1 ? 's' : ''} para esta
                            fecha. Reduce el número de niños.
                          </AlertDescription>
                        </Alert>
                      )}
                        ...
                        <div className="space-y-2">
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <Select
                                value={
                                  field.value ? String(field.value) : 'ninguna'
                                }
                                onValueChange={(v) =>
                                  field.onChange(
                                    v === 'ninguna' ? null : parseInt(v, 10)
                                  )
                                }
                              >
                      ...
                      {efectivoInsuficiente && (
                        ...
                        >
                          ...
                          <div className="grid gap-0.5">
                            ...
                            <AlertDescription className="text-[10px] leading-tight">
                              El efectivo recibido (S/{' '}
                              {efectivoRecibido.toFixed(2)}) es menor que el
                              monto cobrado en efectivo (S/{' '}
                              {efectivoAplicado.toFixed(2)}). Falta recibir S/{' '}
                              {(efectivoAplicado - efectivoRecibido).toFixed(2)}
                              .
                            </AlertDescription>
                          </div>
                        </Alert>
                      ...
                      <div className="pt-4 flex items-start gap-3">
                        ...
                        <div className="grid gap-1.5 leading-none">
                          ...
                          <p className="text-[10px] text-gray-400 dark:text-gray-500">
                            El acompañante ha leído y aceptado los términos del
                            local.
                          </p>
                          {errors.actaFirmada && (
                            <p className="text-[10px] text-red-500 dark:text-red-400">
