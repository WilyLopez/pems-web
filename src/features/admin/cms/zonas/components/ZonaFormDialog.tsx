...
export function ZonaFormDialog({
  ...
  function agregarVideo() {
    if (!VIDEO_REGEX.test(videoInput)) {
      toast.error('URL de video no válida. Debe ser de YouTube o TikTok')
      return
    }
    if (videos.length >= 3) {
      toast.error('Máximo 3 videos permitidos')
      return
    }
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-2 border-t">
                  ...
                  <Button
                    type="submit"
                    disabled={uploading}
                    className="bg-brand-azul text-white min-w-[160px]"
                  >
                    {uploading
                      ? uploadMsg || 'Guardando...'
                      : isEditing
