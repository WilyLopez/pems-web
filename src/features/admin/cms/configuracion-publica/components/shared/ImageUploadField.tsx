...
import { History, Upload, RefreshCw, ExternalLink, Trash2, Image as ImageIcon } from 'lucide-react'
              ...
              {history.map((entry) => (
                <div key={entry.url} className="flex items-center gap-2.5 px-3 py-2.5">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs font-medium truncate text-card-foreground">{entry.nombre}</p>
