...
import { Building2, ImageIcon, Share2, Search, Palette, Phone } from 'lucide-react'
...
export const schema = z.object({
  ...
  whatsapp:             z.string().regex(/^\d{7,15}$/, 'Solo números sin espacios (ej: 51974123456)').optional().or(z.literal('')),
...
export type SectionId = 'negocio' | 'contacto' | 'logos' | 'redes' | 'seo' | 'visual'
