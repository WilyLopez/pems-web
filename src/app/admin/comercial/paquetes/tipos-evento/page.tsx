...
import {
  useTiposEventoAdmin,
  useTipoEventoMutations,
} from '@/features/admin/comercial/tipos-evento/hooks/useTiposEvento'
  ...
  return (
    <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <QuickToggle
                        ...
                        isPending={
                          ...
                          (toggleActivo.variables as TipoEvento)?.codigo ===
                            t.codigo
                        }
                      />
                    </div>
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (deleteCodigo !== null)
            eliminar.mutate(deleteCodigo, {
              onSettled: () => setDeleteCodigo(null),
            })
        }}
