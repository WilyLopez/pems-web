...
export default function InventarioPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog
        open={movDialog.open}
        onOpenChange={(o) => setMovDialog({ open: o, idProducto: null })}
      >
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <Select
                value={form.tipo}
                onValueChange={(v) =>
                  setForm((f) => ({ ...f, tipo: v as MovimientoForm['tipo'] }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setMovDialog({ open: false, idProducto: null })}
            >
              Cancelar
            </Button>
            <Button
              onClick={handleSubmitMovimiento}
              disabled={movimiento.isPending || !form.cantidad || !form.motivo}
            >
