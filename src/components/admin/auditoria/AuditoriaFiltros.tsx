...
export function AuditoriaFiltrosPanel({ filtros, onChange, onBuscar }: Props) {
  function set<K extends keyof AuditoriaFiltros>(
    key: K,
      ...
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(v) => set('accion', v === 'all' ? undefined : v)}
          >
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(v) => set('modulo', v === 'all' ? undefined : v)}
          >
            <SelectTrigger className="w-36 h-9">
