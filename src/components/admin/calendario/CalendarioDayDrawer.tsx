...
export function CalendarioDayDrawer({
  idSede,
  fecha,
  onClose,
          ...
          {data && (
            <div className="p-5 space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  className="flex-1 rounded-xl bg-brand-azul hover:bg-brand-azul/90 text-white text-xs gap-1.5"
                  asChild
                >
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="flex-1 rounded-xl border-brand-rosa text-brand-rosa hover:bg-brand-rosa/5 text-xs gap-1.5"
                  asChild
                >
