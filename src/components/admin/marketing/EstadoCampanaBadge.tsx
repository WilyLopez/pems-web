...
const CONFIG: Record<EstadoCampana, { label: string; cls: string }> = {
  ...
  ENVIANDO:   { label: 'Enviando',   cls: 'bg-amber-100 text-amber-700 border-amber-200' },
  FINALIZADA: { label: 'Finalizada', cls: 'bg-green-100 text-green-700 border-green-200' },
  CANCELADA:  { label: 'Cancelada',  cls: 'bg-red-100 text-red-600 border-red-200' },
}
