...
export const VARIABLES_MARKETING: {
  ...
  },
  {
    ...
    descripcion: 'Nombre del local',
    ejemplo: 'Kiki y Lala',
  },
  {
    nombre: 'promocion',
    descripcion: 'Nombre de la promoción',
    ejemplo: 'Pack Cumpleaños Especial',
  },
  {
    nombre: 'descuento',
    descripcion: 'Porcentaje o valor del descuento',
    ejemplo: '20%',
  },
  {
    nombre: 'fechaVigencia',
    descripcion: 'Fecha límite de la oferta',
    ejemplo: '30/06/2026',
  },
  {
    nombre: 'urlReserva',
    descripcion: 'Enlace para reservar',
    ejemplo: 'https://kikililala.com/reservar',
  },
  { nombre: 'mes', descripcion: 'Mes actual en texto', ejemplo: 'Junio' },
  { nombre: 'anio', descripcion: 'Año actual', ejemplo: '2026' },
  {
    nombre: 'nombreNino',
    descripcion: 'Nombre del niño registrado',
    ejemplo: 'Lucía',
  },
  {
    nombre: 'ultimaVisita',
    descripcion: 'Fecha de la última visita',
    ejemplo: '15/01/2026',
  },
]
...
export function bloquesContienenVariablesBloqueadas(
  bloques: EmailBlock[]
): string | null {
  const VAR_RE = /\{\{(\w+)\}\}/g
