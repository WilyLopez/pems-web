...
import {
  X, Crown, Phone, Mail, MapPin, Building2, BadgeCheck,
  CalendarDays, Clock, Ticket, PartyPopper, CreditCard,
  UserCheck, UserX, Star, RefreshCw, Loader2,
} from 'lucide-react'

import { Cliente } from '@/types/cliente.types'
import { clienteService } from '@/services/cliente.service'
import { ClienteAvatar } from './ClienteAvatar'
import { VipBadge, EstadoBadge, VerificadoBadge, TipoBadge, VisitasBadge } from './ClienteBadges'
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0 space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="font-black text-gray-900 truncate">{cliente.nombre}</h3>
