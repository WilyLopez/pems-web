...
export function aplicarPlantilla(plantilla: string, contrato: Partial<Contrato>): string {
  return plantilla
    ...
    .replace(/\{\{precioTotalContrato\}\}/g,  String(contrato.precioTotalContrato ?? '0.00'))
    .replace(/\{\{montoAdelanto\}\}/g,        String(contrato.montoAdelanto ?? '0.00'))
    .replace(/\{\{saldoPendiente\}\}/g,       String(contrato.saldoPendiente ?? '0.00'))
}