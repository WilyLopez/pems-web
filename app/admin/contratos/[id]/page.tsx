...
import {
  ChevronLeft, FileText, FilePen, CheckSquare, Send,
  Archive, XCircle, Download, ExternalLink, Loader2,
  User, CalendarDays, Users, Clock, Pen,
} from 'lucide-react'
import { useContrato, useActualizarContrato, useFirmarContrato, useCambiarEstadoContrato } from '@/hooks/useContratos'
...
export default function ContratoDetallePage() {
  ...
  const esEditable  = contrato?.estado && !['FIRMADO','CANCELADO','ARCHIVADO'].includes(contrato.estado)
