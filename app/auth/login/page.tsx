...
export default function LoginPage() {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    router.push(
      callbackUrl ?? (tab === 'admin' ? '/admin/dashboard' : '/cliente/mis-entradas'),
    )
    router.refresh()
  }
        ...
        <div className="relative space-y-8 text-center">
          ...
          <div className="text-white space-y-2">
            ...
            <p className="text-white/60 text-sm max-w-xs mx-auto">
              Inicia sesion para ver tus entradas, reservas y acceder a
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as TabType)}>
            <TabsList className="grid w-full grid-cols-2 h-11 rounded-xl bg-gray-100">
              <TabsTrigger
                value="cliente"
                className="rounded-lg font-semibold flex items-center gap-1.5"
              >
