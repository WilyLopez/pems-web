...
const paquetes = [
    ...
    },
    {
        ...
        colorHeader:
            "bg-gradient-to-br from-brand-rosa/15 to-brand-amarillo/10",
        badge: "Mas popular",
        incluye: [
    ...
    },
    {
        ...
        colorHeader:
            "bg-gradient-to-br from-brand-amarillo/15 to-brand-menta/10",
        badge: "Todo incluido",
        incluye: [
            ...
            <section className="relative pt-24 pb-16 bg-gradient-to-br from-brand-rosa/10 via-white to-brand-amarillo/10 overflow-hidden">
                ...
                <div className="container max-w-6xl mx-auto px-4 text-center space-y-5">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                        Organizamos cada detalle para que tu solo tengas que
                        disfrutar. Desde cumpleanos hasta eventos tematicos.
                    </p>
                ...
                <div className="container max-w-6xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600">
                            Todos incluyen coordinacion completa y acceso
                            exclusivo al local
                        </p>
                    </div>
                                ...
                                >
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        ...
                                        <div className="mt-5 space-y-2">
                                            ...
                                            >
                                                <Link
                                                    href={`/eventos-privados?paquete=${id}`}
                                                >
