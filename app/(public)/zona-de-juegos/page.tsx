...
const precios = [
    ...
    },
    {
        ...
        badgeClass:
            "bg-brand-amarillo/20 text-yellow-700 border-brand-amarillo/30",
                ...
                <div className="container max-w-5xl mx-auto px-4">
                            ...
                            ({
                                ...
                                >
                                    <div>
                                        ...
                                        <Badge
                                            className={`mt-2 text-xs ${badgeClass}`}
                                        >
                                            {badge}
                                        </Badge>
                                    </div>
                    ...
                    <div className="mt-8 p-4 bg-brand-amarillo/15 border border-brand-amarillo/30 rounded-2xl flex items-start gap-3">
                        ...
                        <p className="text-sm text-yellow-800">
                            <strong>Consejo:</strong> Los tickets comprados en
                            linea tienen reserva de horario garantizado. En el
                            local sujeto a disponibilidad.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container max-w-6xl mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 mt-1">
                            Cada zona tiene personal de supervision y
                            equipamiento certificado
                        </p>
                    </div>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {zonas.map(
                            ({ icon: Icon, nombre, edad, colorClass }) => (
                                <div
                                    key={nombre}
            ...
            <section className="py-16 bg-brand-rosa/5">
                <div className="container max-w-4xl mx-auto px-4">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 mt-1">
                            Para garantizar la seguridad y diversion de todos
                            los ninos
                        </p>
                    </div>
