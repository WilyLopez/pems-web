                        ...
                        <div className="space-y-8 text-white">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-lg text-white/70 max-w-lg leading-relaxed">
                                    El espacio donde los ninos son los
                                    protagonistas. Juegos, eventos privados y
                                    momentos que jamas olvidaran, en un ambiente
                                    seguro y lleno de alegria.
                                </p>
                            </div>
                            ...
                            <div className="flex items-center gap-6 pt-2">
                                ...
                                <div className="text-center">
                                    <div className="text-3xl font-black text-brand-azul">
                                        4.9
                                    </div>
                                ...
                                <div className="w-px h-10 bg-white/20" />
                                <div className="text-center">
                                    <div className="text-3xl font-black text-brand-menta">
                                        6+
                                    </div>
                                    <div className="text-xs text-white/60">
                                        Anos de experiencia
                ...
                <div className="container max-w-6xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Mas de 15 atracciones disenadas para ninos de 1 a 12
                            anos, con supervision constante y medidas de
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Organizamos eventos privados exclusivos con
                                decoracion personalizada, animacion, catering y
                                todo lo que necesitas para crear recuerdos que
                                duran para siempre.
                            </p>
                ...
                <div className="container max-w-6xl mx-auto px-4">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-white/80">
                            Cada rincon de Kiki y Lala esta disenado pensando en
                        ...
                        {testimonios.map((t) => (
                            ...
                            >
                                <div className="flex gap-0.5 mb-4">
                                    {Array.from({ length: t.estrellas }).map(
                                        (_, i) => (
                                            <Star
                                                key={i}
